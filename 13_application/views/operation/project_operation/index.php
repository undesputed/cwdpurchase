<div class="header">
	<h2>Project Operation Setup</h2>	
</div>

<div class="container">
	<div class="content-title">
		<h3>Create Operation Setup</h3>
	</div>
...
<script type="text/javascript">
	...
	var app = {
		init:function(){					
			...
			$.get('<?php echo base_url().index_page(); ?>/operation/proj_operation/get_list',function(response){
			...
			$.save();
			$.post('<?php echo base_url().index_page(); ?>/operation/proj_operation/insert_list',$('#form').serialize(),function(response){
				$.save({action :'success'});
				switch(response){
					case "0" : 
