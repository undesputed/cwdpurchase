...
<script type="text/javascript">
	...
	var app = {
		init:function(){					
			...
			$.get('<?php echo base_url().index_page(); ?>/operation/proj_area/get_list',function(response){
			...
			$.save();
			$.post('<?php echo base_url().index_page(); ?>/operation/proj_area/insert_list',$('#form').serialize(),function(response){
				$.save({action :'success'});
				switch(response){
					case "0" : 
