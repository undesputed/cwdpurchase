...
<script type="text/javascript">
	...
	var app = {
		init:function(){					
			...
			$.get('<?php echo base_url().index_page(); ?>/operation/activity_scope/get_list',function(response){
			...
			$.save();
			$.post('<?php echo base_url().index_page(); ?>/operation/activity_scope/insert_list',$('#form').serialize(),function(response){
				$.save({action :'success'});
				switch(response){
					case "0" : 
