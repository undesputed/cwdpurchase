<div class="header">
	<h2>Project Productivity <small>Equipment Productivity</small></h2>	
</div>
	...
	var app = {
		init:function(){
			...
			$('#apply_filter').on('click',this.apply_filter);
				...
				$.post('<?php echo base_url().index_page()?>/monitoring/productivity/apply_filter',$post,function(response){
