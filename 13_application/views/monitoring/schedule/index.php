<div class="header">
	<h2>Equipment Service History <small>Schedule Service</small></h2>	
</div>
	...
	<div class="panel panel-default">		
	  <div class="panel-body">
	  		<div class="row">
	  			...
	  			<div class="col-md-3">
	  				<div class="checkbox">
				  			<input type="checkbox" id="all_unit" name="all_unit"><label for="all_unit">All</label>
				  	</div>	
	...
	var app = {
		init:function(){
			...
			$post = {				
				...
				$.post('<?php echo base_url().index_page()?>/monitoring/schedule/apply_filter',$post,function(response){
