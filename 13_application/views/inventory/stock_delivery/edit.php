...
<input type="hidden" value="<?php echo $main['from_title_id']; ?>" id="project">
<input type="hidden" value="<?php echo $main['to_location']; ?>"   id="to_location">
<input type="hidden" value="" id="equipment_id">
<input type="hidden" value="" id="equipment_request_id">
<input type="hidden" value="<?php echo $main['dispatch_id']; ?>" id="dispatch_id">
						  		  		...
						  		  		<div class="row">
						  		  			<div class="col-md-8">
						  		  				<div class="form-group">
														...
														<input type="text" id="deliver_by" class="form-control input-sm uppercase" value="<?php echo $main['delivered_by']; ?>">
												</div>
						  		  			</div>
						  		  			<div class="col-md-4">
						  		  				<div class="form-group">
						  		  		...
						  		  		<div class="row">
						  		  			<div class="col-md-6">	
													<div class="form-group">
														...
														<textarea name="" id="remarks" cols="30" rows="2" class="form-control input-sm"><?php echo $main['remarks'] ?></textarea>														
													</div>
						  		  					<div class="form-group">
									  		  			<div class="control-label">Issued by</div>
									  		  			<select name="" id="issued_by" class="form-control input-sm">
									  		  				<?php  foreach($signatory as $row): ?>
									  		  					<?php $selected = ($row['Person Code']==$main['issued_by'])? 'selected="selected"' : '' ; ?>
						  		  			...
						  		  			<div class="col-md-6">
									  		  		...
									  		  		<div class="form-group">
									  		  			...
									  		  			<select name="" id="approved_by" class="form-control input-sm">
									  		  				<?php  foreach($signatory as $row): ?>
									  		  				<?php $selected = ($row['Person Code']==$main['approved_by'])? 'selected="selected"' : '' ; ?>
									  		  					<option <?php echo $selected; ?> value="<?php echo $row['Person Code'] ?>"><?php echo $row['Full Name']; ?></option>
									  		  				<?php  endforeach;?>
									  		  			</select>
									  		  		</div>
								  		...
								  		<div class="row">
									  		...
									  		<div class="col-md-6">
									  			<div class="form-group">
									  				...
									  				<input type="text" class="form-control input-sm" id="gp_no" value="<?php echo $main['dispatch_no']; ?>" readonly>
								  				</div>					  			
									  		</div>
									  	</div>
								  </div>	 
...
<script type="text/javascript">
	...
	var app_create = {
		init:function(){
			...
			$.post('<?php echo base_url().index_page();?>/inventory/stock_delivery/update_delivery',$post,function(response){				
