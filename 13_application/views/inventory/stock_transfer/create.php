					  				...
					  				<div class="row">
								  		...
								  		<div class="col-md-6">
								  			<div class="form-group">
								  				...
								  				<input type="text" class="form-control input-sm" id="ref_no" readonly>
							  				</div>					  			
								  		</div>
								  	</div>
					  		</div>
						  		  		...
						  		  		<div class="row">
						  		  			<div class="col-md-6">	
													<div class="form-group">
														...
														<textarea name="" id="purpose" cols="30" rows="2" class="form-control input-sm"></textarea>														
													</div>
						  		  					<div class="form-group">
	...
	var app_create = {
		init:function(){
			...
			*/
			...
			$.post('<?php echo base_url().index_page();?>/inventory/stock_transfer/save_stockTransfer',$post,function(response){
