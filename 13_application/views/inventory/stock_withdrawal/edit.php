...
<input type="hidden" value="<?php echo $main['location']; ?>" id="location">
...
<input type="hidden" value="<?php echo $main['withdraw_id'];?>" id="withdraw_id">
					  				...
					  				<div class="row">
								  		...
								  		<div class="col-md-6">
								  			<div class="form-group">
								  				...
								  				<input type="text" class="form-control input-sm" id="mis_no" value="<?php echo $main['withdraw_no']; ?>" readonly>
							  				</div>					  			
								  		</div>
								  	</div>
					  		</div>
...
<script type="text/javascript">
	...
	var app_create = {
		init:function(){
			...
			console.log($post);
			$.post('<?php echo base_url().index_page();?>/inventory/stock_withdrawal/update_withdrawal',$post,function(response){
					if(response==1){
