                         ...
                         <div class="navbar-collapse">
                                <ul class="nav navbar-nav navbar-left">
                                    ...
                                    ?>
                                        ...
                                        <li class="">
                                            <a href="<?php echo base_url().index_page(); ?>/accounting"><strong>ACCOUNTING</strong></a>
                                        </li>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </ul>
                                ...
                                <ul>   
                                    ...
                                    <li class="">
                                        <a class="<?php echo $active['inventory']['a']; ?>" href="javascript:void(0);">
                                            ...
                                            <ul style="<?php echo $active['inventory']['ul']; ?>">
                                                <?php echo $this->lib_transaction->project_site_list(); ?>    
                                            </ul>
                                    </li>
                                    ...
                                    <li class="">
                                        <a href="javascript:void(0);" class="<?php echo $active['item_withdrawal']['a']; ?>">
                                            ...
                                            <ul style="<?php echo $active['item_withdrawal']['u']; ?>">
                                                <li><a class="<?php echo $active['item_withdraw']; ?>" href="<?php echo base_url().index_page() ?>/transaction_list/item_withdrawal"><span>Item Withdrawal</span></a></li>
                                                <li><a class="<?php echo $active['item_issuance']; ?>" href="<?php echo base_url().index_page() ?>/transaction_list/item_issuance"><span>Item Issuance</span></a></li>
                                            </ul>
                                    </li>
                                    ...
                                    <li class="">
                                           ...
                                           <ul style="<?php echo $active['item_transfer']['u']; ?>">
                                               <li><a class="<?php echo $active['item_transfer']['item_request']; ?>"  href="<?php echo base_url().index_page() ?>/transaction_list/item_transfer/item_request"><span>Item Request</span></a></li>
                                               <li><a class="<?php echo $active['item_transfer']['request']; ?>"       href="<?php echo base_url().index_page() ?>/transaction_list/item_transfer/request"><span>Item Transfer</span></a></li>
                                               <li><a class="<?php echo $active['item_transfer']['for_receiving']; ?>" href="<?php echo base_url().index_page() ?>/transaction_list/item_transfer/for_receiving"><span>Item Receiving</span></a></li>
                                           </ul>
                                    </li>

                                    <?php if($this->lib_auth->restriction(array('CANVASS USER'))): ?>
                                    <li>
