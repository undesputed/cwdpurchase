				...
				<div class="panel panel-default">		
				  <div class="panel-body">
				  		...
				  		<div class="form-group">
				  			...
				  			<input type="text" id="project_name" class="form-control input-sm required uppercase">
				  		</div>
						
				  		<div class="form-group">
				  			<div class="control-label">Address</div>
				  			<input type="text" id="project_address" class="form-control input-sm required uppercase">
				  		</div>
				  			
				  		<div class="form-group">
				  			<div class="control-label">Contact No.</div>
				  			<input type="text" id="contact_no" class="form-control input-sm required uppercase">
				  		</div>
...
<script>
	...
	var app_sub_classification ={
		init:function(){
			...
			$.post('<?php echo base_url().index_page();?>/setup/company_setup/get_data',function(response){
			...
			$.post('<?php echo base_url().index_page();?>/setup/company_setup/save_project',$post,function(response){
			...
			var edit = {
				...
				project_name    : tr.find('td.title_name').text(),
				project_address : tr.find('td.title_desc1').text(),
				contact_no      : tr.find('td.title_desc2').text(),
			}
