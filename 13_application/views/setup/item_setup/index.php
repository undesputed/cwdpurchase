	...
	<div class="col-md-5">
		...
		<div class="panel panel-default">		
		  <div class="panel-body">
		  		...
		  		<div class="form-group">
		  			<div class="control-label">Item Code</div>
		  		...
		  		<div class="form-group">
		  			...
		  			<select name="" id="account_name" class="form-control">
		  				...
		  				?>
		  				<option data-classification="<?php echo $row['classification_id'];?>" value="<?php echo $row['id'];?>" data-code="<?php echo $row['account_code'];?>"><?php echo $row['account_description'].' ('.$row['classification_name'].')';?></option>
		  				<?php
		  						}
		  					}
		  				?>
