			...
			<div class="panel panel-default">		
			  <div class="panel-body">
			  		...
			  		<div class="form-group">
			  			...
			  			<input type="text" id="tenant_name" class="form-control input-sm required uppercase">
			  		</div>
				  		...
				  		<div class="row">
				  			<div class="col-md-6">
				  				<div class="form-group">
									...
									<input type="text" id="contract_amount" class="form-control input-sm required numbers_only">
				  				</div>
				  			</div>
				  			<div class="col-md-6">
				  				<div class="form-group">
				  					<div class="control-label">Remarks</div>
									<input type="text" id="remarks" class="form-control input-sm uppercase ">
				  				</div>
				  			</div>				  									
				  		</div>
				  </div>	
...
<script>
	...
	var app_create ={
		init:function(){
			...
			$.post('<?php echo base_url().index_page();?>/setup/tenant_setup/save',$post,function(response){
