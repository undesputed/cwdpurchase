		...
		<div class="panel panel-default">		
		  <div class="panel-body">
		  		...
		  		<div class="form-group">
		  			<div class="control-label">Cost Center</div>
		  			<input type="text" id="cost_center" class="form-control input-sm required uppercase">
		  		</div>
...
<script>
	...
	var app_sub_classification ={
		init:function(){
			...
			$.post('<?php echo base_url().index_page();?>/setup/cost_center/get_cumulative',function(response){
			...
			$.post('<?php echo base_url().index_page();?>/setup/cost_center/save',$post,function(response){
					switch(response){
						case"1": 
							$.save({action : 'success'});
						break;
			...
			var edit = {
				cost_center   : tr.find('td.type').text(),
