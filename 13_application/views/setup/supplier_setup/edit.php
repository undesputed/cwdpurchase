...
<input type="hidden" id="main_id" value="<?php echo $main['business_number']; ?>" class="clear">
		...
		<div class="panel panel-default">		
		  <div class="panel-body">
		  		...
		  		<div class="form-group">
		  			...
		  			<input type="text" id="vat-value" class="form-control" value="<?php echo $main['vat_percentage']?>">
		  		</div>

		  		<div class="form-group">
		  			<div class="control-label">Tin Number</div>		  			
		  			<input type="text" id="tin_number" class="form-control input-sm" value="<?php echo $main['tin_number']?>">
		  		</div>

		  		<div class="form-group">
		  			<div class="control-label">Business Name</div>		  			
		  			<input type="text" id="business_name" class="form-control input-sm required" value="<?php echo $main['business_name']?>">
		  		</div>

		  		<div class="form-group">
		  			<div class="control-label">Trade Name</div>		  			
		  			<input type="text" id="trade_name" class="form-control input-sm" value="<?php echo $main['trade_name']?>">
		  		</div>

		  		<div class="form-group">
		  			<div class="control-label">Address</div>		  			
		  			<input type="text" id="address" class="form-control input-sm" value="<?php echo $main['address']?>">
		  		</div>
		  </div>
		</div>
	</div>
		...
		<div class="panel panel-default">		
		  <div class="panel-body">
		  		...
		  		<div class="form-group">
		  			...
		  			<input type="text" id="mode_of_delivery" class="form-control input-sm" value="<?php echo $main['mode_delivery']?>">
		  		</div>

		  		<div class="form-group">
		  			<div class="control-label">Delivery Lead Time</div>		  			
		  			<input type="text" id="delivery_lead_time" class="form-control input-sm" value="<?php echo $main['leadtime_delivery'] ?>">
		  		</div>

		  		<div class="form-group">
		  			<div class="control-label">Credit Line Limit</div>		  			
		  			<input type="text" id="credit_line_limit" class="form-control input-sm" value="<?php echo $main['credit_limit'] ?>">
		  		</div>
		  		...
		  		<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" id="term_days" class="form-control input-sm" value="<?php echo $main['term_days'] ?>">
					</div>
				</div>		  			
		...
		<div class="panel panel-default">		
				  		...
				  		<div class="row">
				  			<div class="col-md-6">
				  				<div class="form-group">
									...
									<input type="text" id="contact_person" class="form-control input-sm required" value="<?php echo $main['contact_person'] ?>">
				  				</div>
				  			</div>
				  			<div class="col-md-6">
				  				<div class="form-group">
				  					<div class="control-label">Contact No</div>
									<input type="text" id="contact_no" class="form-control input-sm uppercase" value="<?php echo $main['contact_no'] ?>">
				  				</div>
				  			</div>				  									
				  		</div>
				  ...
				  <table id="tbl-contact" class="table table-striped table-hover">
					...
					<tbody>
						...
						<tr>
							<td class="editable contact-type"><?php echo $row['type']; ?></td>
							<td class="editable contact-number"><?php echo $row['tel_no']; ?></td>
						</tr>
					<?php endforeach; ?>
						<tr>
...
<script>
	...
	var app_create ={
		init:function(){
			...
			$('#payment_terms').val("<?php echo $main['term_type']; ?>");
			...
			$.post('<?php echo base_url().index_page();?>/setup/supplier_setup/update_supplier',$post,function(response){
