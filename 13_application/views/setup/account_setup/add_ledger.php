		...
		<div class="panel panel-default">		
		  <div class="panel-body">
		  		...
		  		<div class="form-group">
		  			<div class="control-label">Ledger Name</div>
...
<script>
	...
	var app_sub_classification ={
		init:function(){
			...
			$.post('<?php echo base_url().index_page();?>/setup/account_setup/get_ledger',function(response){
			...
			$.post('<?php echo base_url().index_page();?>/setup/account_setup/save_ledger',$post,function(response){
					switch(response){
						case"1": 
							$.save({action : 'success'});
						break;
