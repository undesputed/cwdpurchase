				...
				<table id="tbl-data" class="table table-hover">
					<thead>
						<tr>
							...
							<th class="txt-center">Drivers DS</th>
					...
					<tbody>
						...
						<tr>							
							...
							<td class="txt-center"><a href="javascript:void(0)" data-shift="ds" class="<?php echo str_replace(' ', '_' ,trim($row['EQUIPMENT'])); ?> get_drivers" data-equipment="<?php echo $row['EQUIPMENT']; ?>"> 0 </a></td>
