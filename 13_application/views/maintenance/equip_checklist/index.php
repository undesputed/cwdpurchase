<div class="header">
	<h2>Equipment Checklist Setup</h2>	
</div>
				  ...
				  <div class="panel-body">
					...
					<form action="" method="POST" id="form">
			  			...
			  			<div class="form-group">
					  		...
					  		<div class="control-label">Item Checklist Name</div>				  		
...
<script type="text/javascript">
	...
	var app = {
		init:function(){					
			...
			$.get('<?php echo base_url().index_page(); ?>/maintenance/equip_checklist/get_checklist',function(response){
			...
			$.post('<?php echo base_url().index_page(); ?>/maintenance/equip_checklist/insert_checklist',$('#form').serialize(),function(response){
