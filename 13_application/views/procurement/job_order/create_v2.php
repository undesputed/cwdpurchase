			...
			<div class="panel panel-default">		
			  <div class="panel-body">
			  		...
			  		<div class="form-group">
			  			...
			  			<input type="text" name="" id="supplier" style="width:100%;" placeholder="Select Supplier">
			  		</div>

			  		<input type="hidden" id="account_code">
			  		<div class="form-group">
			  			<div class="control-label">Attention</div>			  			
			  			<input type='text' name="" id="attention" class="form-control input-sm">
			  		</div>
			  		...
			  		<div class="row">
			  			<div class="col-md-6">
				  			<div class="form-group">
					  			...
					  			<input type="text" name="" id="item_name" style="width:100%" class="form-control" placeholder="Item Description">
				  			</div>
			  			</div>
			  			<div class="col-md-2">
				  				<div class="form-group">
			  		...
			  		<div class="row">	
			  			<div class="col-md-2">
				  			<div class="form-group">
					  			...
					  			<input type="number" name="" id="amount" class="form-control input-sm numbers_only">
				  			</div>
			  			</div>	
			...
			<div class="panel panel-default">		
			  <div class="form-footer">			  	
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
					  			<textarea name="" id="jo_remarks" cols="30" rows="5" class="form-control input-sm" placeholder="Remarks"></textarea>					  			
					  		</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
	...
	var app = {
		init:function(){
			...
			if(DATA.length>0){
				...
				xhr = $.post('<?php echo base_url().index_page(); ?>/procurement/purchase_request/save_joborder',$post,function(response){					
					switch(response){

						case "success":						   	
							$.save({action : 'success',reload : 'true'});
							window.location = '<?php echo base_url().index_page(); ?>/transaction_list/purchase_request/incoming'
						break;
