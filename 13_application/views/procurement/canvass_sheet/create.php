			  		...
			  		<div class="row">
			  			...
			  			<div class="col-md-2">
				  				<div class="form-group">
						  			...
						  			<input type="text" name="" id="canvass_no" class="form-control input-sm" readonly>
					  			</div>
			  			</div>	
			...
			<div class="panel panel-default">		
			  ...
			  <div class="form-footer">			  	
					<div class="row">
						...
						<div class="col-md-4">
							<input id="save" class="btn btn-success col-xs-5 pull-right disabled" type="submit" value="Save">							
						</div>
					</div>					
			  </div>
	...
	var app = {
		init:function(){
			...
			if(typeof ($('#create_profit_center option:selected').val())!= 'undefined'){
				cmbproject = $('#create_profit_center option:selected').val();
			}
			...
			$.post('<?php echo base_url().index_page(); ?>/procurement/canvass_sheet/save_canvass',$post, function(response){
				if(response == 1){
