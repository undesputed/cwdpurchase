...
<div class="container">
	...
	<input type="hidden" id="rr_id"     value="<?php echo $id; ?>">
					...
					<div class="row">
						<div class="col-md-8">
							<div class="form-group">
						  			...
						  			<input type="text" name="" id="delivered_by" class="form-control input-sm uppercase" value="<?php echo $content['delivered_by']; ?>">
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-5">
									<div class="form-group">
							  			...
							  			<select name="" id="received_status" class="form-control input-sm">
											<?php 
												if(($content['received_status']=="FULL")){
													$selected['full'] = "selected='selected'";
													$selected['partial'] = '';
												}else{
													$selected['partial'] = "selected='selected'";
													$selected['full'] = '';
												}
											 ?>
							  				<option value="Full" <?php echo $selected['full'] ?>>Full</option>
							  				<option value="Partial" <?php echo $selected['partial'] ?>>Partial</option>
						...
						<div class="col-md-2">
							<div class="form-group">
						  			...
						  			<input name="" type="text" id="rr_date" class="form-control input-sm" value="<?php echo $content['date_received']; ?>">
							</div>
								
							<div class="form-group">
						  			<div class="control-label">Invoice Date</div>
						  			<input type="text" name="" id="invoice_date" class="form-control input-sm" value="<?php echo $content['invoice_date']; ?>">
							</div>
						...
						<div class="col-md-2">
							...
							<div class="form-group">						  		
						  			...
						  			<input type="text" name="" id="rr_no" class="form-control input-sm" value="<?php echo $content['receipt_no']; ?>">
							</div>

							<div class="form-group">
						  			<div class="control-label">Invoice No</div>
						  			<input type="text" name="" id="invoice_no" class="form-control input-sm" value="<?php echo $content['supplier_invoice']; ?>">
							</div>
	...
	var app_received = {
		init:function(){
			...
			$.signatory({
				...
				received_by : ['7','8','1','2'],
				checked_by  : ['7','2','1','2'],
				noted_by_id : '<?php echo $content["posted_by"]; ?>',
				received_by_id : '<?php echo $content["employee_receiver_id"]; ?>', 
				checked_by_id  : '<?php echo $content["employee_checker_id"]; ?>',
			});
			this.bindEvents();
		},bindEvents:function(){			
			...
			$.post('<?php echo base_url().index_page(); ?>/procurement/received_purchase/update_receiving',$post,function(response){
				if(response == 1){
