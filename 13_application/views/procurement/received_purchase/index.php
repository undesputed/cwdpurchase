...
<script>
	var app = {
		init:function(){
			...
			$.post('<?php echo base_url().index_page();?>/procurement/received_purchase/get_po',$post,function(response){
			...
			$.post('<?php echo base_url().index_page();?>/procurement/received_purchase/get_cumulative',$post,function(response){
			...
			$.fancybox.showLoading();		
			$.post('<?php echo base_url().index_page();?>/procurement/received_purchase/get_po_details',$post,function(response){
				$.fancybox(response,{
					width     : 1000,
					height    : 550,
					fitToView : false,
