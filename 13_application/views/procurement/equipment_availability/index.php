...
<script type="text/javascript">
	...
	var app = {
		init:function(){
			...
			$.post('<?php echo base_url().index_page();?>/procurement/equipment_availability/get_availability',function(response){
				$('.item_content').html(response);
				$('.myTable').dataTable(datatable_option);
			}).error(function(){
				$('.item_content').content_loader('hide');
			...
			$.post('<?php echo base_url().index_page();?>/procurement/equipment_availability/get_details',$post,function(response){
