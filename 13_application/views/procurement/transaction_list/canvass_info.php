						...
						*/
						...
						<div class="t-content">
							<div class="t-header">
								<a href="<?php echo base_url().index_page(); ?>/transaction_list/canvass_sheet" class="close close-info" ><span aria-hidden="true">&times;</span><span></a>
...
<script>
		...
		var canvass_info = {
			...
			bindEvent:function(){
				...
				$('.cv-items').on('click',this.toggle_items);
			...
			toggle_items:function(){
				...
				$.post('<?php echo base_url().index_page();?>/transaction/check_canvass',$post,function(resp){
					if(resp == 'TRUE'){
						...
						alert('Incomplete Approved Item Supplier!');
					}
				});
