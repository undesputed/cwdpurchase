				...
				<div class="row">
					<div class="col-xs-12">
						<a href="<?php echo base_url().index_page(); ?>/transaction_list/item_transfer/item_request/create" class="btn pull-right btn-primary btn-sm" style="margin:5px">Create Material Request</a>
								 ...
								 ?>
									<tr class="hover <?php echo $active; ?>">
										...
										<td>
											...
											<a href="<?php echo base_url().index_page(); ?>/transaction_list/item_transfer/item_request/<?php echo $row1['transfer_no']; ?>"><?php echo $row1['transfer_no']; ?></a>
										</td>																				
