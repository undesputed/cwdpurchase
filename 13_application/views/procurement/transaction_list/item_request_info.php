...
<div class="t-content">
	<div class="t-header">
		<a href="<?php echo base_url().index_page(); ?>/transaction_list/item_request" class="close"><span aria-hidden="true">&times;</span><span></a>
	...
	<div class="row">
		<div class="col-xs-6">
			<div class="control-group">
				...
				<?php $project_code = $this->session->userdata('Proj_Code'); ?>
				<?php if($main_data['to_project_id'] == $project_code): ?>
				<?php if($main_data['request_status'] != 'APPROVED'): ?>
		...
		<div class="col-xs-6">
			...
			<div class="control-group">
				<a href="<?php echo base_url().index_page();?>/print/item_request_report/<?php echo $main_data['transfer_no']; ?>" target="_blank" class="action-status"><i class="fa fa-print"></i> Print</a>
			</div>
