...
<input type="hidden" value="<?php echo $rr_main['receipt_no'] ?>" id="rr_no" class="required">
<input type="hidden" value="<?php echo $supplier['supplier_id']; ?>" id="supplier_id">
						...
						<div class="t-content">
							<div class="t-header">
								...
								<h4 id="rr-no-title"><?php echo $rr_main['receipt_no'] ?><small> Editing....</small></h4>
							</div>
							<div class="row">
								<div class="col-xs-6">
							...
							<div class="row" style="margin-top:10px">
								<div class="col-xs-5">
									<div class="t-title">
										<div>RR Date : </div>
										<input type="text" id="rr_date" class="form-control date required" value="<?php echo $rr_main['date_received']; ?>">
									</div>
									<div class="t-title">
										<div>S.I No : </div>
										<input type="text" id="invoice_no" class="form-control required" value="<?php echo $rr_main['supplier_invoice']; ?>">
									</div>
									<div class="t-title">
										<div>S.I Date : </div>
										<input type="text" id="invoice_date" class="form-control date required" value="<?php echo $rr_main['invoice_date']; ?>">
									</div>
									<div class="t-title">
										<div>D.R No : </div>
										<input type="text" id="dr_no" class="form-control required" value="<?php echo $rr_main['dr_no']; ?>">
									</div>
									<div class="t-title">
										<div>Status : </div>
										<span id="_status">
								...
								<tbody>
									<?php 
										...
										<tr>
											...
											<td class="itemName"><?php echo $row['item_name_actual'];?></td>
											<td class="unit_msr"><?php echo $row['unit_msr'];?></td>
											<td class="qty td-number td-qty"><?php echo $row['item_quantity_ordered']; ?></td>
											<td class="td-qty td-number"><input type="number" class="form-control required rr-qty numbers_only" style="width:80px" value="<?php echo $row['item_quantity_actual']; ?>"></td>
											<td class="td-number unit_cost"><?php echo $this->extra->number_format($row['item_cost_ordered']);?></td>
											<!-- <td class="td-number total_unit_cost"></td> -->											
							...
							<div class="row">								
								<div class="col-xs-12">
									<button class="pull-right btn btn-primary" id="save">Update</button>
								</div>
							</div>
		...
		var event_app = {
			...
			received_event:function(){
				...
				event_app.execute_query($post);
					...
					$post = {
						rr_id           :   '<?php echo $rr_main['receipt_id'] ?>',
					...
					$.save({appendTo : 'body'});				
					xhr = $.post('<?php echo base_url().index_page();?>/procurement/received_purchase/update_receiving',$post,function(response){
