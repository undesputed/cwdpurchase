	...
	<div class="dropdown search-item" style="float:left;position:relative;z-index:9999">
		<a href="javascript:void(0)" id="filter"  class="search-item dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-filter"></i> Filter </a>
		    <ul class="dropdown-menu filter-menu" role="menu">
		      <li><a href="javascript:void(0)" class="filter-item " data-url = "<?php echo base_url().index_page(); ?>/transaction_list/get_po_forprinting?p=1&filter=all" >All  <i class="fa fa-check"></i></a></li>
		      <li><a href="javascript:void(0)" class="filter-item active"  data-url  = "<?php echo base_url().index_page(); ?>/transaction_list/get_po_forprinting?p=1&filter=without_print">Approved Without Print <i class="fa fa-check"></i></a></li>
		    </ul>
	</div>
