...
<div role="tabpanel">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="<?php echo base_url().index_page(); ?>/transaction_list/inventory/">Inventory</a></li>
    <!-- <li role="presentation"><a href="<?php echo base_url().index_page(); ?>/transaction_list/withdrawal">Withdrawal</a></li>
			...
			<div class="row">
				<div class="col-xs-9">
					<div style="margin:5px">
						<select name="" id="category-select" style="display:none;"></select>
					</div>
				</div>
				<div class="col-xs-3">
					<div class="control-group">
						<a href="<?php echo base_url().index_page();?>/print/inventory/<?php echo $this->uri->segment(3); ?>" target="_blank" class="action-status"><i class="fa fa-print"></i> Print</a>
						<a href="<?php echo base_url().index_page();?>/transaction_list/forward" target="_blank" class="action-status"><i class="fa fa-forward"></i> Forward</a>
					</div>
				</div>
			</div>
	...
	$(function(){
		...
		var a_app = {
			init:function(){
				...
				$.post('<?php echo base_url().index_page();?>/transaction_list/get_inventory_item',$post,function(response){
