...
<div role="tabpanel">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="active"><a href="<?php echo base_url().index_page(); ?>/transaction_list/issuance">Issuance</a></li>    
  </ul>
  <!-- Tab panes -->
			...
			<div class="row">
				...
				<div class="col-xs-2">
					<div class="control-group">
						<a href="<?php echo base_url().index_page();?>/print/inventory_issuance" target="_blank" class="action-status"><i class="fa fa-print"></i> Print</a>
					</div>
				</div>
			</div>
	...
	$(function(){
		...
		var a_app = {
			init:function(){
				...
				$.post('<?php echo base_url().index_page();?>/transaction_list/get_issuance_item',$post,function(response){
