						...
						<div class="t-content">
							...
							<div class="row" style="margin-top:10px">
								...
								<div class="col-md-4">
									<div class="t-title">
										<div>PO No : </div> 
										<strong><input type="text" id="reference_no" readonly="readonly" value="<?php echo $main_data['reference_no']; ?>"></strong>
									</div>
									<div class="t-title">
										<div>P.O Date : </div> 
								...
								<tbody>
									<?php 
										...
										<tr>
											...
											<td class="brand"><input type="text" style="width:100px" class="input_brand" value="<?php echo $row['brand'];?>"></td>											
			...
			bindEvent:function(){
				...
				$('#tbl-po tbody tr').each(function(i,val){
					var data = {
						...
						brand            : $(val).find('.input_brand').val(),
