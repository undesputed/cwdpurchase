...
<div class="container">	
	...
	<div class="row">
		...
		<input type="hidden" id="pr_id" value="<?php echo $main[7]; ?>">
		<input type="hidden" id="supplier_id" value="<?php echo $supplier['business_number']; ?>">
		<input type="hidden" id="can_id" value="<?php echo $main[0]; ?>">
			  		...
			  		<div class="row">
			  			<div class="col-md-6">
				  			<div class="form-group">
						  			...
						  			<input type="text" name="pr_no" id="pr_no" class="form-control input-sm " value="<?php echo $main[3] ?>" readonly>
				  			</div>
			  			</div>
			  			...
			  			<div class="col-md-2">
			  				<div class="form-group">
						  			...
						  			<input type="text" name="canvass_no" id="canvass_no" class="form-control input-sm date" value="<?php echo $main[1] ?>" readonly>
					  			</div>
			  			</div>
			  			...
			  			<div class="col-md-2">
				  				<div class="form-group">
						  			...
						  			<input type="text" name="po_date" id="po_date" class="form-control input-sm date" readonly>
					  			</div>
			  			</div>
			  			...
			  			<div class="col-md-2">
				  				<div class="form-group">
						  			...
						  			<input type="text" name="po_no" id="po_no" class="form-control input-sm" readonly>
					  			</div>
			  			</div>	
			  		...
			  		<div class="row">
			  				<div class="col-md-4">
					  			...
					  			<div class="form-group">
						  			...
						  			<input type="text" name="po_remarks" id="po_remarks" class="form-control input-sm">
					  			</div>
			  				</div>	
			  				...
			  				<div class="col-md-4">
			  					<div class="form-group">
						  			...
						  			<input type="text" name="delivery_term" id="delivery_term" class="form-control input-sm">
					  			</div>
			  					<div class="form-group">
						  			<div class="control-label">Date of Delivery</div>
						  			<input type="text" name="date_delivery" id="date_of_delivery" class="form-control input-sm date" value="">
					  			</div>
			  					<div class="form-group">
		...
		<div class="col-md-12">
				...
				<div class="table-responsive table-overflow">
					  <table class="table table-striped">
					  	...
					  	<tbody>
					  		<?php $total = 0;$total_unitprice = 0 ; ?>
					  		<?php foreach($item as $key => $value): ?>
					  			<?php $total +=$value['TOTAL']; ?>
					  			<?php $total_unitprice +=$value['UNIT PRICE']; ?>
						  		<tr>
					  	...
					  	<tfoot>
					  		<tr>
					  			...
					  			<td><h4><strong><?php echo $this->extra->number_format($total_unitprice);?></strong></h4></td>
					  			<td><h4><strong><?php echo $this->extra->number_format($total); ?></strong></h4></td>
					  			<td></td>
					  		</tr>
					  	</tfoot>
					  </table>
	...
	var app_po = {
		init:function(){
			...
			if(typeof ($('#profit_center option:selected').val())!= 'undefined'){
				cmbproject = $('#profit_center option:selected').val();
			}
