	  		...
	  		<div class="">
				<div class="head_date">
				 ...
				 <?php foreach($row as $row1): ?>
						...
						<div class="item_contents hover pop_up_content" data-method="return" data-type="return" data-value="<?php echo $row1['po_number']; ?>" data-url="<?php echo base_url().index_page(); ?>/transaction_list/return/<?php echo $row1['po_number']; ?>">
		    ...
		    <?php if($next!="" || $next > 1): ?>
				<a class="jscroll-next" href='<?php echo base_url().index_page(); ?>/transaction_list/get_return_list?p=<?php echo $next; ?>&filter=<?php echo $filter.$search_url; ?>'>Next</a>
	  		<?php endif; ?>