...
<script>
	...
	var app ={
		init:function(){
			...
			xhr = $.post('<?php echo base_url().index_page();?>/accounting_entry/balance_sheet/get_balance_sheet',$post,function(response){
			...
			$('#print').on('click',function(){
				...
				window.open('<?php echo site_url('print/balance_sheet_single/');?>?from='+from+'&to='+to+'&location='+location+'',"Print");
