	...
	<input type="hidden" id="cash_voucher_id" value="<?php echo $main['cash_voucher_id'] ?>">
		...
		<div class="row">
			...
			<div class="col-xs-5">
				...
				<div class="form-group inline pull-right">
					...
					<span class="control-item-group">
						<a href="<?php echo base_url().index_page(); ?>/print/cash_vouchering/<?php echo $main['cash_voucher_id'] ?>" class="action-status" target="_blank">Print</a>				
					</span>
					|
		...
		<div class="row" style="margin-top:5px">
			<div class="col-md-6 col-info">
				...
				<strong>TIN : </strong>	 <?php echo $main['tin']; ?>
				<br>
				<br>
		...
		var app = {
			init:function(){
				...
				*/
				...
				$.post('<?php echo base_url().index_page();?>/accounting/edit',$post,function(response){
					$.fancybox(response,{
						width     : 1200,
						height    : 550,
						fitToView : true,
