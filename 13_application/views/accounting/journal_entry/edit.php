...
<?php 
	...
	*/
	...
	$transaction_type = array(
		array('title'=>'JEV','short'=>'JEV','type'=>'JOURNAL ENTRY','trans_type'=>'JOURNAL ENTRY'),	
	);
						...
						<div class="col-md-12">	
							...
							<div class="panel panel-default">		
							  <div class="panel-body">						
										...
										<select name="" id="transaction_type" class="form-control input-sm" style="display:none">
											...
											<tbody>
												<tr>
													...
													<td>
							  						...
							  						<td>JEV No.:</td>
							  						<td>
							  							<input type="text" name="" id="reference_no" class="form-control input-sm" readonly value="<?php echo $main['reference_no']; ?>">
							  						</td>
												</tr>
												<tr>
													<td>Project Type</td>
													<td>
														<select name="" id="pay_item" class="form-control input-sm">
											  				...
											  				<?php $selected = ($row['id'] == $main['pay_item'])? "selected='selected'" :''; ?>
											  				<option <?php echo $selected ?> value="<?php echo $row['id']; ?>"><?php echo $row['project_name']; ?></option>
											  				<?php endforeach;?>
										  				</select>
							  						</td>
							  						<td>Transaction Date:</td>
													<td><input type="text" name="" id="date" class="form-control date transaction_date input-sm" value="<?php echo $main['trans_date']; ?>"></td>
												</tr>												
												<tr>
													<td></td>
													<td></td>
													<td>Reference No:</td>
													<td><input type="text" id="memo" class="form-control" value="<?php echo $main['memo']; ?>"></td>
												</tr>												
											</tbody>												
										</table>
					  ...
					  <table class="table table-striped table-hover table-condensed tbl-journal tbl-event">
					  		...
					  		<tbody>
								...
								<tr>
					  				...
					  				<?php 
					  				 ...
					  				 ?>			  													  			
					  				<td class="editable-amount debit"><?php echo $debit; ?></td>
					  				<td class="editable-amount credit"><?php echo $credit; ?></td>
					  		...
					  		<tfoot>
					  			<tr>
					  				...
					  				<td class="total_debit sub-total"><?php echo number_format($total_debit,2); ?></td>
					  				<td class="total_credit sub-total"><?php echo number_format($total_credit,2); ?></td>
					  				<td></td>
					  			</tr>
					  		</tfoot>
					  </table>
					  <div class="form-footer">
								<div class="row">
									<div class="col-md-8"> 
										...
										<input name="" id="particulars" class="form-control" value="<?php echo $main['particulars']; ?>">											
									</div>									
									<div class="col-md-4">
										<input id="save" class=" btn btn-success col-xs-5 pull-right " type="submit" value="Update" style="margin-top:1.2em">								
									</div>
								</div>
					   </div>
					</div>
...
<script>
	...
	var app ={
		init:function(){
			...
			$post = {
				journal_id  : '<?php echo $main['journal_id']; ?>',
			...
			xhr = $.post('<?php echo base_url().index_page();?>/accounting_entry/journal_entry/update',$post,function(response){
				switch(response){
					case"1":
