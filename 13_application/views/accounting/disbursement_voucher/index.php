...
<input type="hidden" value="<?php echo $dv_no; ?>" id="dv_no">
				...
				<div class="row">
					<div class="col-md-4">
						<table class="table">								
							...
							<tr>
								<td>Voucher Date:</td>
								<td><input type="text" class="form-control date" id="date"></td>
							</tr>
							<tr>
								<td>Payment Type:</td>
								<td>
							...
							<tr class="">
								...
								<td>
									<input type="text" class="form-control check-group" id="check_no">
								</td>
							</tr>
							<tr class="">
	...
	var application ={
		init:function(){
	        ...
	        $post = {
	        	...
	        	si_no     : $('#sales_invoice option:selected').val(),	        	
	        	...
	        	project_type : $('#project_category option:selected').val(),
	        };
