	...
	<div class="col-md-6">
		<div class="control-group">	
			<span class="control-item-group">
				<a href="<?php echo base_url().index_page(); ?>/print/cash_voucher/<?php echo $rr_main[0]['receipt_no']; ?>" target="_blank" class="action-status cancel-event">Print</a>			
			</span>
			<span>
				<a href="<?php echo base_url().index_page(); ?>/accounting/voucher/edit/" class="action-status history-link" data-method="cash_voucher" data-type="edit" data-value="<?php echo $journal_id; ?>">Edit</a>
			</span>
		</div>
	</div>
</div>
...
<div class="row" style="margin-top:5px">
	...
	<div class="col-md-6">
		<table class="table">										
			...
			<tr>
				<td>Invoice No:</td>
				<td><strong><?php echo $rr_main[0]['supplier_invoice'] ?></strong></td>
			</tr>
			<tr>
	...
	<div class="col-md-6">
		<table class="table">
			...
			<tr>
				...
				<td>
					<?php echo $subsidiary['subsidiary']; ?>
				</td>
			</tr>
			<tr>
				<td style="width:80px">Check No :</td>
				<td>
					<?php echo $subsidiary['check_no']; ?>
				</td>
			</tr>
			<tr>
				<td style="width:80px">Check Date:</td>
				<td>
					<?php echo $subsidiary['check_date']; ?>
				</td>
			</tr>						
