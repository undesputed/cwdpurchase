...
<div>
	<div class="row">
		<div class="col-md-10">
					<div class="container">
						<h2 style="text-decoration:underline;">JOURNAL VOUCHER</h2>
					<div class="row">
						<div class="col-md-4">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								 <label for="">Date</label>
				  				 <input id="date" type="text" class="form-control full-text required" tabindex="3">
							</div>
							<div class="form-group">
						...
						<table class="table">
							<thead>
								<tr>
									...
									<th class="center border"> SUBSIDIARY</th>
