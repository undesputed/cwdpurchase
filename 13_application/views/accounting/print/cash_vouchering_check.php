...
<div style="width:900px" >
	...
	<table style="width:100%;margin-top:1em">
		...
		<tbody>
			...
			<tr style="">				
				<td>
					<span style="margin-left:7em;">SI <?php echo $main['invoice_no']; ?> / PO <?php echo $main['po_no']; ?></span>
				</td>
				<td style="border-left:1px solid #333;border-right:1px solid #333;width:4px;"></td>
				<td style="text-align:center"><?php echo number_format($main['total_amount']); ?></td>
			</tr>
			...
			<tr>				
				<td>
					<table style="width:100%">
						<tr>
							<td>PROJECT: </td>
							<td><strong><?php echo $main['project_name']; ?></strong></td>
							<td>TOTAL P </td>
						</tr>
					</table>
				</td>
				<td style="border-left:1px solid #333;border-right:1px solid #333;width:4px;"></td>
				<td style="text-align:center"><strong><?php echo number_format($main['total_amount']); ?></strong></td>
			</tr>
			<tr>
