...
<div style="width:900px" >
	<div class="container">
		<h2 style="text-decoration:underline;text-align:center;">Journal Voucher</h2>
	<table style="margin-top:3em;width:100%">	
		...
		<tr>
			<td></td>
			<td class="border_bottom" style="width:450px"><?php echo $main['type']." ".$main['short_desc']; ?></td>
	...
	<table style="width:100%;margin-top:1em">
		...
		<tbody>
			...
			<tr>				
				<td>
					<div style="margin-bottom:2em;margin-top:2em;"></div>
	...
	<table style="width:100%;margin-top:1em">
		...
		<tbody>
			...
			<?php if($row['dr_cr'] == 'DEBIT'){
				  ...
				  $subsidiary =(empty($row['subsidiary']) || $row['subsidiary']=="")? "" : $row['subsidiary'];
			...
			<tr style="">				
				<td>
					<span style="margin-left:<?php echo $margin; ?>;"><?php echo $row['account_description'] ."    ".$subsidiary; ?></span>
				</td>
				<td style="border-left:1px solid #333;border-right:1px solid #333;width:4px;"></td>
			...
			<td>
					<table border=1 style="width:100%">
						...
						<tr style="height:60px">
							<td style="text-align:center"><?php echo $main['preparedBy_name']; ?></td>
