...
<script>
	...
	var app ={
		init:function(){
			...
			$.post('<?php echo base_url().index_page();?>/accounting_entry/change_in_equity/get_cumulative',$post,function(response){
			...
			$('#print').on('click',function(){
				...
				window.open('<?php echo site_url('print/change_in_equity/');?>?from='+from+'&to='+to+'&location='+location+'',"Print");
