...
<div style="margin-top:5px">
		<ul class="nav nav-tabs" role="tablist">
		    <li><a href="<?php echo base_url().index_page(); ?>/accounting_entry/payroll_entry">Main</a></li>
		    <li class="active"><a href="<?php echo base_url().index_page(); ?>/accounting_entry/payroll_entry/cumulative">Cumulative Data</a></li>
	  	</ul>
 </div>
	...
	$(function(){
		...
		var app = {
			init:function(){
				...
				$.post('<?php echo base_url().index_page();?>/accounting_entry/payroll_entry/get_cumulative',$post,function(response){
					$('#data').html(response);
				...
				xhr = $.post('<?php echo base_url().index_page();?>/accounting_entry/payroll_entry/get_journal_details',$post,function(response){
					$.fancybox(response,{
						width     : 1000,
						height    : 550,
						fitToView : false,
				...
				$.post('<?php echo base_url().index_page();?>/accounting_entry/payroll_entry/cancel',$post,function(response){
						app.get_cumulative();
				});				
			}
		}
