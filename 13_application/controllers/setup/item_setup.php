...
class Item_setup extends CI_Controller {
	...
	public function index(){
		...
		$data['account_name'] = $this->md_item_setup->get_account_name();
	...
	public function get_data(){
		...
		$show = array(
				...
				array('data'=>'item_code','style'=>'display:none'),
				array('data'=>'account_id','style'=>'display:none'),
				array('data'=>'item_type','style'=>'display:none'),
				'Action',
			 	);
			...
			foreach($result->result_array() as $key => $value){
				...
				$row_content[] = array('data'=>$value['item_code'],'class'=>'code');
				...
				$row_content[] = array('data'=>$value['item_code'],'class'=>'item_code','style'=>'display:none');
				$row_content[] = array('data'=>$value['account_id'],'class'=>'account_id','style'=>'display:none');
				$row_content[] = array('data'=>$value['type'],'class'=>'item_type','style'=>'display:none');
