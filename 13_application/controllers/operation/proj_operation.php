...
class Proj_operation extends CI_Controller {
	...
	public function index(){
		...
		$this->lib_auth->title = "Project Operation Setup";		
		$this->lib_auth->build = "operation/project_operation/index";
	...
	public function get_list(){
		...
		$overide = array('operation_type'=>'Description','code'=>'Code');
		$result = $this->md_project_operation->operation();
	...
	public function insert_list(){
		...
		if($this->input->post('id')!=""){
			...
			if($this->md_project_operation->update_operation()){
				echo "2";
			}else{
				echo "1";
			}
			...
			if($this->md_project_operation->insert_operation()){
				echo "0";
			}else{
				echo "1";
			}
