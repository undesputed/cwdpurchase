...
class Enter_payable extends CI_Controller {
	...
	public function index(){
		...
		$data['view'] =	$this->load->view('accounting/enter_payable/enter_payable_list','',true);
		$this->lib_auth->title = "Enter Payable";
	...
	public function form(){
		...
		$this->load->view('accounting/enter_payable/form',$data);
