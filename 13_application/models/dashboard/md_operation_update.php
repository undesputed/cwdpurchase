...
class Md_operation_update extends CI_Model {
	...
	function display(){
		...
		$sql = "CALL project_operationupdate_equipment('".$this->input->post('location')."','".$this->input->post('date_from')."','".$this->input->post('date_to')."');";
